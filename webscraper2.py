...
# ------------------ Create Stealth Driver (Headless) ------------------ #

def get_driver(user_agent):
    options = uc.ChromeOptions()
    options.add_argument('--headless=new')  # Safer, modern headless mode
...
df.to_csv("headless_stealth_scraped_books.csv", index=False)
print("Data saved to 'headless_stealth_scraped_books.csv'.")
